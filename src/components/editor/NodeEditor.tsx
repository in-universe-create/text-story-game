...
export default function NodeEditor() {
  ...
  const [conditionType, setConditionType] = useState<'stat' | 'flag'>('stat');
  ...
  useEffect(() => {
    ...
    if (edgeData?.choice) {
      ...
      if (condition) {
        ...
        setConditionType(condition.type === 'flag' ? 'flag' : 'stat');
            ...
            {hasCondition && (
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <select
                    value={conditionType}
                    onChange={(e) => setConditionType(e.target.value as 'stat' | 'flag')}
                ...
                {/* 조건 미리보기 */}
                <div className="p-2 bg-[#eaeae5] border border-[#d0d0c8] text-xs text-[#4d4d4d]">
                  {conditionType === 'stat' ? (
                    <>
                    ...
                    <>
                      플래그 <span className="font-medium">{conditionFlagName || '(미설정)'}</span>가 활성화되었을 때 선택 가능
                    </>
                  )}
                </div>
              </div>
                  ...
                  <div key={index} className="p-2 bg-[#eaeae5] border border-[#d0d0c8]">
                    ...
                    <select
                      ...
                      onChange={(e) => handleUpdateEffect(index, {
                        ...
                        target: e.target.value === 'stat' ? 'hp' : e.target.value === 'flag' ? '' : ''
                      })}
