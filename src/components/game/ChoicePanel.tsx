            ...
            className={`
              ...
              ${
                !isAvailable
                  ...
                  : 'bg-[var(--bg-secondary)] hover:bg-[var(--bg-tertiary)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:translate-x-2'
              }
          ...
          >
            <span className="inline-flex items-center gap-3">
              <span className={`
                ...
                ${isAvailable ? 'bg-[var(--btn-secondary-bg)] text-[var(--btn-secondary-text)]' : 'bg-[var(--bg-tertiary)] text-[var(--text-muted)]'}
              `}>
                {index + 1}
              </span>
